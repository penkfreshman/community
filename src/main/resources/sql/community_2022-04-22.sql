...
# Database: community
# Generation time: 2022-04-22T15:38:26+08:00
# ************************************************************
...
INSERT INTO `carcharge` (`id`, `pay_date`, `end_date`, `money`, `status`, `owner_id`, `remarks`, `type`, `park_id`) VALUES
	(11, '2021-12-18 16:00:00', '2022-03-19', 2200, 1, 21, '', '停车费', 1),
	(12, '2021-12-18 16:00:00', '2022-03-19', 2200, 1, 2, '', '停车费', 2);
...
INSERT INTO `clockin` (`id`, `clock_in_time`, `owner_id`, `house_id`, `building_id`) VALUES
	(18, '2022-04-19 06:20:30', 21, 7, 12),
	(19, '2022-04-19 08:34:17', 2, 2, 7),
	(20, '2022-04-19 08:47:11', 9, 4, 11),
	(21, '2022-04-20 09:27:30', 21, 7, 12);
...
INSERT INTO `clockinnew` (`id`, `report_date`, `owner_id`, `type1`, `type2`, `today_address`, `remarks`) VALUES
	...
	(21, '2022-04-18 16:00:00', 21, 0, 0, 'cq', '');
...
INSERT INTO `complaint` (`id`, `com_id`, `com_date`, `handle_date`, `owner_id`, `status`, `clr`, `remarks`) VALUES
	...
	(6, '2', '2022-04-19 06:37:01', NULL, 21, 0, NULL, '投诉类型少');
...
CREATE TABLE `house` (
  ...
  `identity` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `house` (`id`, `storey`, `numbers`, `status`, `into_date`, `building_id`, `remarks`, `area`, `identity`) VALUES
	(2, NULL, '401', 1, '2020-11-04 16:00:00', 7, '', 112, '10987654321'),
	(3, NULL, '201', 1, '2020-11-17 15:52:58', 1, NULL, 100, '2222222222222'),
	(4, NULL, '602', 1, '2021-05-05 16:00:00', 11, '', 98, '11111111111'),
	(6, NULL, '101', 1, '2022-04-07 16:00:00', 7, '', 50, '00000000000'),
	(8, NULL, '111', 0, '2022-04-14 16:00:00', 7, '', 101, ''),
	(14, NULL, '125', 1, '2022-04-20 16:00:00', 1, '', 101, '12345678910'),
	(20, NULL, '120', NULL, '2022-04-21 16:00:00', 11, '', 202, '12345678910');
...
INSERT INTO `owner` (`id`, `username`, `tel`, `sex`, `identity`, `house_id`, `remarks`, `password`) VALUES
	(2, '老张', '13767134678', '男', '10987654321', 2, '', '12345'),
	(9, '小李', '15270839876', '男', '11111111111', 4, '', '12345'),
	(13, '小张', '17347982200', '男', '2222222222222', 3, '', '12345'),
	(15, '小彭', '15270839876', '男', '00000000000', 6, '', '12345'),
	(21, '小红', '15270892323', '女', '12345678910', 14, '', '12345');
...
INSERT INTO `property_info` (`id`, `type_id`, `money`, `start_date`, `end_date`, `status`, `house_id`, `remarks`) VALUES
	...
	(65, 1, 260, '2022-02-28 16:00:00', '2022-05-31 16:00:00', 1, 3, ''),
	(66, 1, 254.8, '2022-02-28 16:00:00', '2022-05-31 16:00:00', 1, 4, ''),
	(69, 3, 55.5, '2022-04-07 16:00:00', '2022-04-07 16:00:00', 1, 2, ''),
	...
	(76, 1, 291.2, '2021-12-31 16:00:00', '2022-04-05 16:00:00', 0, 2, ''),
	(77, 1, 260, '2021-12-31 16:00:00', '2022-04-05 16:00:00', 0, 3, ''),
	(78, 1, 254.8, '2021-12-31 16:00:00', '2022-04-05 16:00:00', 0, 4, ''),
	(79, 1, 130, '2021-12-31 16:00:00', '2022-04-05 16:00:00', 0, 6, '');
...
INSERT INTO `repair` (`id`, `com_id`, `com_date`, `handle_date`, `owner_id`, `status`, `clr`, `remarks`) VALUES
	...
	(17, '3', '2022-04-19 06:36:33', NULL, 21, 0, NULL, '');
...
INSERT INTO `userinfo` (`id`, `password`, `type`, `remarks`, `username`, `identity`) VALUES
	...
	(10, '12345', b'00000001', NULL, 'admin', '无');
...
# Dump completed on 2022-04-22T15:38:26+08:00
