!function (t, e) {
    ...
    function To(t) {
        var e = [];
        return f(pk.getClassesByMainType(t), function (t) {
    ...
    function Zo(t, e) {
        ...
        f(e, function (e, a) {
            "colorLayer" === a && i || pk.hasClass(a) || ("object" == typeof e ? t[a] = t[a] ? r(t[a], e, !1) : n(e) : null == t[a] && (t[a] = e))
        })
    }
    ...
    function jo(t, e, i) {
        var n = e.type ? e.type : i ? i.subType : pk.determineSubType(t, e);
        return n
    }
    ...
    ar(pk, {registerWhenExtend: !0}), Xa(pk), Ya(pk, To), c(pk, vx);
    var xx = "";
    ...
    var Ox = jn(), zx = "\x00_ec_inner", Ex = Wa.extend({
        init: function (t, e, i, n) {
            ...
            function e(e, n) {
                ...
                i[e] = [], a.set(e, []), f(s, function (t, n) {
                    ...
                    if (O(S(s) || r, "Empty component definition"), s) {
                        var h = pk.getClass(e, t.keyInfo.subType, !0);
            ...
            Oo(this), f(t, function (t, e) {
                null != t && (pk.hasClass(e) ? e && s.push(e) : i[e] = null == i[e] ? n(t) : r(i[e], t, !0))
            }), pk.topologicalTravel(s, pk.getAllClassMainTypes(), e, this), this._seriesIndicesMap = N(this._seriesIndices = this._seriesIndices || [])
        }, getOption: function () {
            var t = n(this.option);
            ...
            e.each(function (t, e) {
                i.push(e)
            }), pk.topologicalTravel(i, pk.getAllClassMainTypes(), function (i) {
    ...
    var a_ = jn(), o_ = pk.extend({
        ...
        mergeDefaultAndTheme: function (t, e) {
            ...
            pk.hasClass(a) && (a += "Series"), r(t, e.getTheme().get(this.subType)), r(t, this.getDefaultOption()), Fn(t, "label", ["show"]), this.fillDataTextStyle(t.data), i && So(t, n, i)
        },
    ...
    O_.categoryAxis.splitLine.show = !1, pk.extend({
        type: "dataset",
    ...
    var R_ = {
        ...
        }, X_ = O, Y_ = f, j_ = w, q_ = S, U_ = pk.parseClassType, $_ = "4.2.0", K_ = {zrender: "4.0.5"}, Q_ = 1, J_ = 1e3,
    ...
    var Fb = ["value", "category", "time", "log"], Vb = function (t, e, i, n) {
        ...
        }), pk.registerSubTypeDefaulter(t + "Axis", x(i, t))
    }, Wb = pk.extend({
    ...
    r(Wb.prototype, vb);
    var Gb = {offset: 0};
    Vb("x", Wb, Wu, Gb), Vb("y", Wb, Wu, Gb), pk.extend({
        type: "grid",
    ...
    jl(rM), pk.registerSubTypeDefaulter("legend", function () {
        return "plain"
    });
    var aM = JS.extend({
        type: "legend.scroll",
    ...
    pk.registerSubTypeDefaulter("timeline", function () {
        return "slider"
    ...
    }), Yl(jM), pk.registerSubTypeDefaulter("dataZoom", function () {
        return "slider"
    });
